  ...
  return (
    <div>
      <div className='flex justify-between items-center'>
        <div>
          <h3 className='font-semibold mt-3 text-2xl mb-3'>Cancel Order Page</h3>
          <div className='mb-4'>
            <input
              type='text'
        ...
        <div>
          <Link to='/cancel-order-completed'>
            <button className='bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded'>Cancel Order Completed</button>
          </Link>
        </div>
      </div>
      <div>
            ...
            order.returnOrderStatus !== "Order Placed" && order.returnOrderStatus !== "Return Confirmed" && order.returnOrderStatus !== "Cancel Confirmed" && order.returnOrderStatus !== "Order Returned" && (
              <div key={index} className='border-2 border-gray-200 p-5 md:p-8 my-3 md:my-4 text-xs sm:text-sm text-gray-700'>
                ...
                <div className='mt-8'>
                  ...
                  <p className='text-3xl font-medium'>{order.cancelReason}</p>
                </div>
              </div>
            )
          ))
